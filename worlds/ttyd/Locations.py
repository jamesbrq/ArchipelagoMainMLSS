...
petal_right: typing.List[LocationData] = [
    ...
    LocationData("Petalburg Westside: Courage Shell", 78780172, Rels.nok, [0x3C30]),
    LocationData("Petalburg Westside: Fire Flower", 78780173, Rels.nok, [0x3C20]),
    LocationData("Petalburg Westside: Honey Syrup", 78780174, Rels.nok, [0x3C40]),
    LocationData("Petalburg Westside: Mr. Softener", 78780175, Rels.nok, [0x3C38]),
    LocationData("Petalburg Westside: Mushroom", 78780176, Rels.nok, [0x3C48]),
    LocationData("Petalburg Westside: POW Block", 78780177, Rels.nok, [0x3C28]),
    ...
    LocationData("Petalburg Eastside: Turtley Leaf", 78780181, Rels.nok, [0x978C])
]
...
petal_left: typing.List[LocationData] = [
    ...
    LocationData("Petal Meadows Bridge Room: Koops", 78780185, Rels.hei, [0x26BF4]),
...
hooktails_castle: typing.List[LocationData] = [
    ...
    LocationData("Hooktail's Castle Stair Switch Room: Shine Sprite", 78780197, Rels.gon, [0xCE00]),
...
boggly_woods: typing.List[LocationData] = [
    ...
    LocationData("Boggly Woods Flurrie's House: Flurrie", 78780227, Rels.win, [0x6304]),
...
great_tree: typing.List[LocationData] = [
    ...
    LocationData("Great Tree Shop: Honey Syrup", 78780246, Rels.mri, [0x40FE0]),
    LocationData("Great Tree Shop: HP Drain", 78780247, Rels.mri, [0x40FC0]),
    LocationData("Great Tree Shop: Ice Storm", 78780248, Rels.mri, [0x40FC8]),
    LocationData("Great Tree Shop: Mini Mr.Mini", 78780249, Rels.mri, [0x40FD8]),
    LocationData("Great Tree Shop: Mushroom", 78780250, Rels.mri, [0x40FE8]),
    LocationData("Great Tree Shop: Mystery", 78780251, Rels.mri, [0x40FD0]),
...
glitzville: typing.List[LocationData] = [
    ...
    LocationData("Glitzville Minor-League Room: Yoshi", 78780298, Rels.tou, [0x40A20]),
...
twilight_town: typing.List[LocationData] = [
    ...
    LocationData("Twilight Town Leftside: Vivian", 78780305, Rels.usu, [0x1744C]),
...
twilight_trail: typing.List[LocationData] = [
    ...
    LocationData("Twilight Trail Entrance: Black Key 3", 78780320, Rels.gra, [0x4A60]),
...
creepy_steeple: typing.List[LocationData] = [
    ...
    LocationData("Creepy Steeple Main Hall: Steeple Key 1", 78780435, Rels.jin, [0xD938]),
...
keelhaul_key: typing.List[LocationData] = [
    ...
    LocationData("Keelhaul Key Landing Site: Whacka Bump 2", 78780455, Rels.muj, [0x160D4]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 3", 78780456, Rels.muj, [0x160F8]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 4", 78780457, Rels.muj, [0x1611C]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 5", 78780458, Rels.muj, [0x16140]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 6", 78780459, Rels.muj, [0x16164]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 7", 78780460, Rels.muj, [0x16188]),
    LocationData("Keelhaul Key Landing Site: Whacka Bump 8", 78780806, Rels.muj, [0x161AC]),
    ...
    LocationData("Keelhaul Key Grotto Entrance: Bobbery", 78780488, Rels.muj, [0x51324]),
