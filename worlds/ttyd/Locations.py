...
boggly_woods: typing.List[LocationData] = [
    ...
    LocationData("Boggly Woods Flurrie's House: Flurrie", 78780227, Rels.win, [0xDFD4]),
...
pirates_grotto: typing.List[LocationData] = [
    ...
    LocationData("Pirate's Grotto Spike Wall Room: Shine Sprite", 78780510, Rels.dou, [0xD858]),
